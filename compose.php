...
$ins="insert into Inbox1 (Receiver,Sender,Subject,Message)values('$Receiver','$Sender','$Subject','$Message')";
		$res = mysql_query($ins);
...
$ins="insert into Draft (Receiver1,Sender,Subject,Message)values('$to','$username','$sub','$Msg')";
		$res = mysql_query($ins);
